...
Suggest rideshares to travellers who live near each other.
...
To run the tests, enter the rideshare_matchmaker/tests directory and run the following commands::
